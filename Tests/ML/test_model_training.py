...
def _test_model_train(output_dirs: OutputFolderForTests,
    ...
    # train_config.recovery_checkpoints_save_last_k = 2
    ...
    if machine_has_gpu:
        ...
        expected_train_losses = [0.4552919, 0.4548537]
    ...
    # TODO antonsc: Move back when the callback is re-enabled
    ...
    train_dice_region = [[0.0, 0.0, 0.0], [0.0372, 0.0388, 0.1091]]
